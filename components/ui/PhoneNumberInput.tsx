...
// Sample country data - in a real application, this would be a more comprehensive list
// stored in a separate file or fetched from an API
...
export function PhoneNumberInput({
  ...
  const filteredCountries = sampleCountries.filter(
    (country) =>
  ...
  const handlePhoneNumberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (onChange) {
      onChange(newValue, selectedCountry.dial_code);
    }
  };
      ...
      <div className="relative">
        ...
        >
          ...
          <button
            ...
            className="flex items-center px-3 py-2 bg-gray-50 border-r border-gray-300"
            ...
            <div className="sticky top-0 bg-white p-2 border-b border-gray-200">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-8 py-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
                {searchTerm && (
                  <button
            ...
            <ul className="py-1">
              {filteredCountries.length > 0 ? (
                filteredCountries.map((country) => (
                  <li key={`${country.code}-${country.dial_code}`}>
                    <button
                      type="button"
...
const sampleCountries: Country[] = [
  ...
  { name: "Curaçao", dial_code: "+5999", code: "CW", flag: "🇨🇼" },
  ...
  { name: "Dominican Republic", dial_code: "+1", code: "DO", flag: "🇩🇴" }, // Shared +1
  ...
  { name: "Guernsey", dial_code: "+44", code: "GG", flag: "🇬🇬" }, // Shared +44
  ...
  { name: "Hong Kong SAR China", dial_code: "+852", code: "HK", flag: "🇭🇰" },
  ...
  { name: "Isle of Man", dial_code: "+44", code: "IM", flag: "🇮🇲" }, // Shared +44
  { name: "Israel", dial_code: "+972", code: "IL", flag: "🇮🇱" },
  { name: "Italy", dial_code: "+39", code: "IT", flag: "🇮🇹" },
  { name: "Jamaica", dial_code: "+1", code: "JM", flag: "🇯🇲" }, // Shared +1
  { name: "Japan", dial_code: "+81", code: "JP", flag: "🇯🇵" },
  { name: "Jersey", dial_code: "+44", code: "JE", flag: "🇯🇪" }, // Shared +44
  { name: "Jordan", dial_code: "+962", code: "JO", flag: "🇯🇴" },
  { name: "Kazakhstan", dial_code: "+7", code: "KZ", flag: "🇰🇿" }, // Shared +7
  { name: "Kenya", dial_code: "+254", code: "KE", flag: "🇰🇪" },
  { name: "Kiribati", dial_code: "+686", code: "KI", flag: "🇰🇮" },
  { name: "Kosovo", dial_code: "+383", code: "XK", flag: "🇽🇰" }, // User assigned code
  ...
  { name: "Macao SAR China", dial_code: "+853", code: "MO", flag: "🇲🇴" },
  ...
  { name: "Mayotte", dial_code: "+262", code: "YT", flag: "🇾🇹" }, // Shared +262
  ...
  { name: "Norfolk Island", dial_code: "+672", code: "NF", flag: "🇳🇫" }, // Shared +672
  ...
  { name: "Pitcairn Islands", dial_code: "+64", code: "PN", flag: "🇵🇳" }, // Shared +64 (implicitly)
  { name: "Poland", dial_code: "+48", code: "PL", flag: "🇵🇱" },
  { name: "Portugal", dial_code: "+351", code: "PT", flag: "🇵🇹" },
  { name: "Puerto Rico", dial_code: "+1", code: "PR", flag: "🇵🇷" }, // Shared +1
  ...
  { name: "Saint Barthélemy", dial_code: "+590", code: "BL", flag: "🇧🇱" }, // Shared +590
  ...
  { name: "Saint Martin", dial_code: "+590", code: "MF", flag: "🇲🇫" }, // Shared +590
  {
  ...
  { name: "São Tomé and Príncipe", dial_code: "+239", code: "ST", flag: "🇸🇹" },
  ...
  { name: "Svalbard and Jan Mayen", dial_code: "+47", code: "SJ", flag: "🇸🇯" }, // Shared +47
  ...
  { name: "Vatican City", dial_code: "+3906", code: "VA", flag: "🇻🇦" }, // Shared +39
  ...
  { name: "Western Sahara", dial_code: "+212", code: "EH", flag: "🇪🇭" }, // Shared +212
